!(function (e, t) {
    ...
    function oe() {
        ...
        (e.classList.add("vbox-child"),
            ...
            (e.style.transition =
                "transform " + r.settings.transitionSpeed + "ms"));
    ...
    function ae(e) {
        if (!y) {
            ...
            ((a.style.transition =
                ...
                (N = D =
                    "touchstart" === e.type ? e.touches[0].pageX : e.pageX),
                (T = v =
                    "touchstart" === e.type ? e.touches[0].pageY : e.pageY),
                (X = !0));
        }
    }
    function re(e) {
