                    ...
                    <div class="filter col-lg-3 d-lg-block d-none">
                        ...
                        <div class="categories ">
                                ...
                                <div class="priceBox position-relative">
                                    ...
                                    <div class="priceRangeWrapper">
                                        <div class="priceRangeOpen">
                                            <div class="range">
                                                <input type="range" name="pieces" id="inputPieces" max="2000"
                                                    value="50" multiple="">
                                            </div>
                            ...
                            <div class="rating">
                                ...
                                <ul class="ratingOpen">
                                    <li class="d-flex align-items-center">
                                        ...
                                        <label for="All">
                                            <iconify-icon icon="twemoji:star" width="20"
                            ...
                            <div class="discount mb-5">
                                <a href="#">
                                    <img class="img-fluid" src="{{ asset('frontend/img/d-Bannar.png') }}"
                                        alt="Image 1" class="img-fluid"></a>
                                </a>
                            </div>
                            <!-- ------------------------ Discount End Here ------------  -->
                            ...
                            <div class="seleCard">
                                <a href="#">
                                    <div class="row">
                                        ...
                                        src="{{ asset('frontend/img/FreshMango.png') }}" alt="Image 1"
                                        class="img-fluid">
                                        <div class="col-8">
                                            <h4>Red Capsicum</h4>
                                            ...
                                            <div class="review">
                                                ...
                                                <iconify-icon icon="twemoji:star" width="15"
                                                    height="15"></iconify-icon>
                                                <iconify-icon icon="heroicons:star-20-solid" width="20"
                                                    height="20" style="color: #b3b3b3"></iconify-icon>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                ...
                <section id="ProductCardBox">
                    <div class="row justify-content-center">
                        <div class="productCard  ">
                            <div class="thumbnail">
                                <a href="#"><img src="{{ asset('frontend/img/mango.png') }}" alt="Image 1"
                                        class="img-fluid"></a>
                                <ul class="quickLinks">
                                    <li><a href="#"><iconify-icon icon="prime:heart" width="24"
                                                height="24"></iconify-icon></a></li>
                                    <li><a href="./product.html"><iconify-icon icon="proicons:eye" width="24"
                                                height="24"></iconify-icon></a></li>
                                </ul>
                            </div>
                            <div class="content">
                        ...
                        <div class="productCard ">
                            <div class="thumbnail">
                                <a href="#"><img src="{{ asset('frontend/img/Product Image.png') }}" alt="Image 1"
                                        class="img-fluid"></a>
                                <ul class="quickLinks">
                                    <li><a href="#"><iconify-icon icon="prime:heart" width="24"
                                                height="24"></iconify-icon></a></li>
                        ...
                        <div class="productCard ">
                            <div class="thumbnail">
                                <a href="#"><img src="{{ asset('frontend/img/Product Image.png') }}"
                                        alt="Image 1" class="img-fluid"></a>
                                <ul class="quickLinks">
                                    <li><a href="#"><iconify-icon icon="prime:heart" width="24"
                                                height="24"></iconify-icon></a></li>
                    ...
                    <div class="pagination justify-content-center">
                        <div class="d-flex justify-content-center">
                            <a class="leftPage">
                                <iconify-icon icon="iconamoon:arrow-left-2-light" width="24"
                            ...
                            <a class="next">50</a>
                            <a class="rightPage">
                                <iconify-icon icon="iconamoon:arrow-right-2-light" width="24"
                                    height="24"></iconify-icon>
                            </a>
                        </div>
                    </div>
        ...
        <div class="subcribeArea">
          <div class="row align-items-center">
            <div class="subcribeLogo d-none d-md-block col-lg-3 col-12 text-center">
              <a href="#"><img class="img-fluid" src="{{ asset('frontend/img/Product Image.png') }}" alt="Image 1" class="img-fluid"></a>Logo .png" alt="Logo"></a>
            </div>
